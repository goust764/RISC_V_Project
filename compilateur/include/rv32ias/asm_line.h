...
//========== Rescources liées à la simulation
#define REG_COUNT 32
#define MEM_DEFAULT_VALUE 0xFF
...
/**
 * @brief Affiche une ligne assembleur de manière plus lisible
 * 
 * @param asm_line Ligne assembleur à afficher
 * @return int - 0
 */
...
/**
 * @brief Simule l'exécution d'une liste d'instructions assembleur
 * 
 * @param insn_list Liste d'instructions à exécuter
 * @param mem_size Taille de la mémoire
 * @return int - 0 si tout s'est bien passé, -1 sinon
 */
int asm_line_sim(list_t* insn_list, unsigned int mem_size);
/**
 * @brief Affiche des informations sur l'exécution d'une liste d'instructions assembleur
 * 
 * @param print_type Type du message à afficher
 * @param regfile Registre à afficher
 * @param pc Valeur du PC
 * @param asm_line Ligne assembleur à afficher
 * @param format Format du message à afficher
...
/**
 * @brief Affiche le code System Verilog correspondant à un test lié à l'écriture dans une mémoire
 * 
 * @param clock_number Cycle d'horloge auquel le test est effectué
 * @param pc Valeur du PC au cycle d'horloge
 * @param instruction Instruction à testé
 * @param adress Adresse à laquelle la mémoire est écrite
 * @param data_size Taille des données écrites
 * @param data Valeur des données écrites
 * @param nb_tests Numéro du test
 */
...
/**
 * @brief Affiche les registres lors d'une simulation
 * 
 * @param regfile Registres à afficher
 */
