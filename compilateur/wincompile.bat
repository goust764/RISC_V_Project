...
set prog[0].dir=prog/
@REM set prog[0].arg=test.asm database.txt  test.bin
@REM set prog[0].arg=../prog/asm_bench_global.asm database.txt ../prog/asm_bench_global.bin 
set prog[0].arg=../prog/test_ble.asm database.txt ../prog/test_ble.bin -v
